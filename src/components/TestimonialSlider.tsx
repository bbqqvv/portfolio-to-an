...
export default function SkillSlider() {
    ...
    return (
        <div
            id="skill"
            className="flex flex-col items-center p-4 sm:p-6 md:p-8 w-full"
        ...
        >
            <h2
                ...
                style={{ fontFamily: "Eczar, sans-serif", color: "var(--foreground-2)" }}
            >
                Kỹ năng của tôi
            </h2>
            <p
                className="mb-6 sm:mb-8 text-sm sm:text-base md:text-lg text-center max-w-2xl mx-auto"
                style={{ fontFamily: "Work Sans, sans-serif", color: "var(--text-muted)" }}
            >
            ...
            <div className="flex flex-col sm:flex-row items-center w-full max-w-3xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full overflow-hidden">
                    ...
                    >
                        <p className="text-sm sm:text-base mb-3 sm:mb-4" style={{ color: "var(--foreground-2)" }}>
                            {skills[currentIndex].text}
                        </p>
                        <p className="text-sm sm:text-base font-semibold" style={{ color: "var(--foreground-2)" }}>
                    ...
                    <motion.div
                        ...
                        transition={{ type: "spring", stiffness: 100 }}
                    >
                        <p className="text-base mb-4" style={{ color: "var(--foreground-2)" }}>
                            {skills[(currentIndex + 1) % skills.length].text}
                        </p>
                        <p className="font-semibold" style={{ color: "var(--foreground-2)" }}>
                ...
                <div className="flex sm:hidden justify-center gap-8 mt-6 w-full">
                    <button
                        ...
                        aria-label="Kỹ năng trước"
                        onMouseEnter={(e) => (e.currentTarget.style.color = "var(--button-hover-text)")}
                        onMouseLeave={(e) => (e.currentTarget.style.color = "var(--button-text)")}
                    >
                        <ChevronLeft size={20} />
                    </button>
                    <button
                ...
                <div className="sm:hidden mt-4 flex gap-2">
                    {skills.map((_, index) => (
                        <button
                            ...
                            style={{
                                backgroundColor: currentIndex === index ? "var(--foreground-2)" : "var(--text-muted)",
                            }}
